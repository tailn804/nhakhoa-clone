<template>
    ...
    <div style="color: rgba(47, 47, 47, 1);" class=" grid sm:w-full grid-cols-1 sm:px-24 w-[90%] pt-[72px] mx-auto">
        ...
        <!-- About -->
        <div class="text-[18.0pt]">Your Sample Base Page</div>
        <div class="mt-2">
            <div class="text-[14.0pt]">Have you explored Google Spaces for internal communications?</div>
            <div class="text-[14.0pt]">Set up your teams for success and foster collaboration.</div>
        </div>
        ...
        <div class="pt-[92px] grid sm:grid-cols-2 grid-cols-1 px-3 text-[19px] gap-7 leading-9">
            <div>
                <span class="font-bold text-[14.0pt] block">
                    Mission & Vision
                </span>
                <span class="block mt-2 text-[14.0pt]" >
                    You can use spaces or group conversations in Google Chat to <br> communicate with one or more people.
                </span>
                <ul class="list-square pl-5 text-[14.0pt]">
                    <li >
                        Spaces: A central place where people can share files, assign tasks, and stay connected.
                    </li>
                    <li>
                        Group conversations: Chat directly with a group. For example, <br> use group conversations to have a quick discussion after a meeting.
                    </li>
                </ul>
                <span>
            ...
            <div>
                <div>
                <span class="font-bold text-[14.0pt] block">
                    Five Year Plan Aligned Goals
                </span>
                <span class="block mt-2 text-[14.0pt]" >
                    Collaborate on long-term projects with teams or specific <br> groups. 
                </span>
                <ul class="list-square pl-5 text-[14.0pt]">
                    <li >
                    ...
                    <li>
                        If you use a work or school Google Account, the administrator may turn history on or off. 
                    </li>
                </ul>
                <span>
                    When history is:
                ...
                <ul class="list-square pl-5 text-[14.0pt]">
                    <li >
                        On: Messages follow your organization's data retention policy. If you use a personal account, messages are kept indefinitely.
                    </li>
                    <li>
    ...
    <div style="color: rgba(47, 47, 47, 1);" class="py-[84px] sm:px-24 sm:grid sm:grid-cols-3 flex flex-col justify-center items-center    bg-[#f9f9f9]">
        <div class="sm:w-full col-span-2 sm:pr-6 leading-8 w-[90%]">
            ...
            <span class="mt-2 block text-[14.0pt]">
    ...
    <div style="color: rgba(47, 47, 47, 1);" class="sm:w-full sm:px-24  flex flex-col justify-center items-center  pb-[76px] bg-[#f9f9f9] ">   
